...
// ── MALWAREBAZAAR ──────────────────────────────────────
// Blocks all browser CORS proxies — skipped
export async function fetchMalwareBazaar() {
  setSrc('malware', 'skip', 'N/A');
  return [];
}

// ── ALL RSS FEED DEFINITIONS ───────────────────────────
export const RSS_FEEDS = [
  ...
  { id: 'arxiv', url: 'https://arxiv.org/rss/cs.CR',                 name: 'ArXiv CS.CR'      },
];